<?php
/**
 * Adressen storage implementation for PHP's PEAR database abstraction layer.
 *
 * The table structure can be created by the scripts/sql/adressen_foo.sql
 * script.
 *
 ...
 * @package  Adressen
 */
class Adressen_Driver_Sql extends Adressen_Driver
{
    /**
    ...
    public function retrieve()
    {
        ...
        try {
            ...
            throw new Adressen_Exception($e);
        }
